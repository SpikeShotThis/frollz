Feature: Device Management
  ...
  Scenario: Create a one-slot film holder
    Given I have opened the add device form
    And I have chosen the device type of "Film Holder"
    When I select the format "4x5"
    And I create a film holder named "Single Slot Holder" with brand "Fidelity", holder type "Standard", and slot count "1"
    Then the created film holder "Single Slot Holder" has slot count "1"
